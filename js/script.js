document.addEventListener("DOMContentLoaded", () => {
    ...
    var myAnimation = new hoverEffect({
        ...
        image1: `assets/${bgImgs[0]}`,
        image2: `assets/${bgImgs[1]}`,
    ...
    var myAnimation2 = new hoverEffect({
        ...
        intensity: 0.3,
        imagesRatio: 1080 / 1920,
        image1: `assets/${bgImgs[1]}`,
        image2: `assets/${bgImgs[2]}`,
        displacementImage: "assets/14.jpg",
        hover: false
    });
    ...
    var myAnimation3 = new hoverEffect({
        ...
        intensity: 0.3,
        imagesRatio: 1080 / 1920,
        image1: `assets/${bgImgs[2]}`,
        image2: `assets/${bgImgs[3]}`,
        displacementImage: "assets/14.jpg",
        hover: false
    });
    ...
    var myAnimation4 = new hoverEffect({
        ...
        intensity: 0.3,
        imagesRatio: 1080 / 1920,
        image1: `assets/${bgImgs[3]}`,
        image2: `assets/${bgImgs[0]}`,
        displacementImage: "assets/14.jpg",
        hover: false
    });
